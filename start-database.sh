...
DB_CONTAINER_NAME="may-workout-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=may-workout -d -p 5432:5432 docker.io/postgres
